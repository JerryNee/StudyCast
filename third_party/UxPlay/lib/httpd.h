...
struct httpd_callbacks_s {
    ...
    int   (*conn_recv)(void *ptr, int socket_fd, void *buffer, size_t length);
    int   (*conn_send)(void *ptr, int socket_fd, const void *buffer, size_t length);
    void  (*conn_response_sent)(void *ptr);
